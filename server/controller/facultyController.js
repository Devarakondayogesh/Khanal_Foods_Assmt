...
export const facultyLogin = async (req, res) => {
  ...
  try {
    ...
    // If the password is the default one, prompt for password change
    if (existingFaculty.password === 'default-hashed-password') {
      errors.passwordError = "You must change your default password.";
    ...
    console.log(error);
    res.status(500).json({ backendError: "An error occurred. Please try again." });
  }
};
